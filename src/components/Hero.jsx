  ...
  return (
    <div className="h-[90%]">
      <div className="bg-[#F4F9FB] h-[80%]">
        <div className="mx-[20px] md:max-w-[1160px] md:mx-auto flex flex-col-reverse md:flex-row md:justify-between items-center gap-[30px]">
          <div className="text-center md:text-left my-[25px] md:my-0">
