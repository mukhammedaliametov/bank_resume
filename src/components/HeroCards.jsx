...
const HeroCards = () => {
  return (
    <div className="mx-[20px] md:max-w-[1160px] md:mx-auto my-[70px]">
      <div className="overflow-scroll md:overflow-hidden gap-[20px] flex items-center justify-between">
        <div className="bg-[#F4F9FB] text-center w-[252px] h-[317px] md:w-[360px] md:h-[400px] rounded-[16px]">
          <img src={Icon1} alt="hero_icon_1" className="mx-auto mt-[45px]" />
        ...
        <div className="bg-[#F4F9FB] text-center w-[360px] h-[400px] rounded-[16px]">
          <img src={Icon2} alt="hero_icon_2" className="mx-auto mt-[45px]" />
        ...
        <div className="bg-[#F4F9FB] text-center w-[360px] h-[400px] rounded-[16px]">
          <img src={Icon3} alt="hero_icon_3" className="mx-auto mt-[45px]" />
      ...
      <div className="flex justify-between flex-col md:flex-row relative items-center gap-[30px] mt-[30px]">
        <div className="flex items-center gap-[30px] w-[370px] md:w-[560px] h-[250px] md:h-[280px] bg-[#F4F9FB] px-[25px] md:px-[40px] py-0 md:py-[20px] rounded-[16px]">
          <div className="w-[308px]">
            <h4 className="text-[18px] font-semibold">Для работодателей</h4>
        ...
        <button className="block md:hidden w-[98%] mx-auto mt-[-20px] bg-[#007DB6] text-[#fff] text-[15px] py-[13px] px-[30px] mr-[20px] rounded-[4px] font-light cursor-pointer">
          Вход
        </button>
        <div className="flex items-center gap-[30px] w-[370px] md:w-[560px] h-[170px] md:h-[280px] bg-[#F4F9FB] px-[25px] md:px-[40px] py-0 md:py-[20px] rounded-[16px] ">
          <div className="w-[308px]">
